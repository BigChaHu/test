...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon('./UI/r1.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('./UI/r2.jpg'))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('./UI/r3.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('./UI/r4.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('./UI/r5.jpg'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('./UI/p1.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('./UI/p2.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('./UI/p3.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('./UI/p4.jpg'))
        ...
        ''')
        # 播放进度条和播放控制按钮组了，我们需要将播放进度条的样色设置为浅红色，然后去除播放控制按钮的边框
